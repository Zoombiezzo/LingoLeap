...
{
    [Serializable]
    public class LayoutElementAdaptiveUIOrientationState : AdaptiveUIOrientationState<AdaptiveUIHorizontalOrVerticalLayoutGroup>
    {
        [SerializeField] [ReadOnly]
        private AdaptiveUIHorizontalOrVerticalLayoutGroup _element;
        ...
        public LayoutElementAdaptiveUIOrientationState(AdaptiveUIHorizontalOrVerticalLayoutGroup element, AdaptiveUIOrientation orientation)
        {
        ...
        public override void Apply(AdaptiveUIHorizontalOrVerticalLayoutGroup element)
        {
            if(_isEnabled == false)
                return;
