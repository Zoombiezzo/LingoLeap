...
{
    public class HorizontalSingleBankItemViewFactory : IBankItemFactory
    {
        private readonly ISpriteDatabaseService _spriteDatabaseService;
        private readonly IPurchaseService _purchaseService;

        public HorizontalSingleBankItemViewFactory(ISpriteDatabaseService spriteDatabaseService, IPurchaseService purchaseService)
        {
        ...
        public IBankItemView Create(Transform parent, IBankItemView prefab, IBankItem item)
        {
            ...
            if (view is HorizontalSingleBankItemView targetView == false)
                return view;
