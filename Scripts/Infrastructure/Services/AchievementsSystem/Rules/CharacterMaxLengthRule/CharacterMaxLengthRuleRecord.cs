...
{
    public class CharacterMaxLengthRuleRecord : AchievementRuleRecord
    {
        [JsonProperty] private int _count;
        [JsonIgnore] private CharacterMaxLengthRuleInfo _info;
        ...
        [JsonIgnore] public CharacterMaxLengthRuleInfo Info => _info;

        public CharacterMaxLengthRuleRecord()
        {
            
        }
        
        public CharacterMaxLengthRuleRecord(string id, CharacterMaxLengthRuleInfo info) : base(id, info)
        {
            _info = info;
            _count = 0;
        }
        ...
        public override void RegisterInfo(AchievementRuleInfo info)
        {
            ...
            if (info is CharacterMaxLengthRuleInfo == false)
            {
                throw new System.Exception("AchievementInfo is not CharacterMaxLengthRuleInfo");
                return;
            }
            
            _info = (CharacterMaxLengthRuleInfo) info;
        }
