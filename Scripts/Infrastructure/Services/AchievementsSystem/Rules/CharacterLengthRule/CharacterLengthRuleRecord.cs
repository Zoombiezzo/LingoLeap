...
{
    public class CharacterLengthRuleRecord : AchievementRuleRecord
    {
        
        [JsonProperty] private int _count;
        [JsonIgnore] private CharacterLengthRuleInfo _info;
        ...
        [JsonIgnore] public CharacterLengthRuleInfo Info => _info;

        public CharacterLengthRuleRecord()
        {
            
        }
        
        public CharacterLengthRuleRecord(string id, CharacterLengthRuleInfo info) : base(id, info)
        {
            _info = info;
            _count = 0;
        }
        ...
        public override void RegisterInfo(AchievementRuleInfo info)
        {
            ...
            if (info is CharacterLengthRuleInfo == false)
            {
                throw new System.Exception("AchievementInfo is not CharacterCountRuleInfo");
                return;
            }
            
            _info = (CharacterLengthRuleInfo) info;
        }
