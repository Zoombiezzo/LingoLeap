...
namespace _Client.Scripts.Tools.Layout.Editor
{
    [CustomEditor(typeof(VerticalOrHorizontalLayoutGroup), true)]
    [CanEditMultipleObjects]
    /// <summary>
    /// Custom Editor for the VerticalOrHorizontalLayoutGroup Component.
    /// Extend this class to write a custom editor for a component derived from HorizontalOrVerticalLayoutGroupEditor.
    /// </summary>
    public class VerticalOrHorizontalLayoutGroupEditor : UnityEditor.Editor
    {
        ...
        SerializedProperty m_layoutDirection;
        ...
        protected virtual void OnEnable()
        {
            ...
            m_layoutDirection = serializedObject.FindProperty("m_layoutDirection");
        }
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.PropertyField(m_layoutDirection, true);
