...
namespace _Client.Scripts.Tools.Animation.Custom
{
    public partial class CustomUIAnimation
    {
        ...
        private class RelativeMoveUIAnimationCustom : CustomAnimation
        {
            ...
            private Vector3 _startedAnchoredPosition;
            
            public RelativeMoveUIAnimationCustom()
            {
                
            }
            
            public RelativeMoveUIAnimationCustom(RectTransform rectTransform)
            {
            ...
            {
                var startedPosition = _startedAnchoredPosition;
                ...
                sequence.Append(DOVirtual.Float(0f, 1f, _duration,
                    value =>
                    {
                        ...
                        _rectTransform.anchoredPosition = startedPosition + new Vector3(x, y);
                    }));
